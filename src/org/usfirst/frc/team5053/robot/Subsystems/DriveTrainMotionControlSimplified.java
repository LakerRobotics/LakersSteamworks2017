...
//FromRudy import edu.wpi.first.wpilibj.command.Subsystem;
...
import edu.wpi.first.wpilibj.SpeedController;
	 ...
	 *
	 */
    public class DriveTrainMotionControlSimplified extends RobotDrive implements Subsystem {
		...
		public DriveTrainMotionControlSimplified(SpeedController leftMotor, SpeedController rightMotor) 
		{
		...
		public DriveTrainMotionControlSimplified(SpeedController leftMotor, SpeedController rightMotor, Encoder leftEncoder, Encoder rightEncoder)
		{
			super(leftMotor, rightMotor);
...
//			m_DistancePIDWrapper = new DistancePIDWrapper(this);
		...
		public DriveTrainMotionControlSimplified(SpeedController leftMotor, SpeedController rightMotor, Encoder leftEncoder, Encoder rightEncoder, ADXRS450_Gyro Gyro)
		{
			super(leftMotor, rightMotor);
